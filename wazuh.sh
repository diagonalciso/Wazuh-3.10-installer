...
sed -i 's/^#cluster\.initial_master_nodes: \["node-1", "node-2"]/cluster.initial_master_nodes: ["node-1"]'/i# read -p "Press [Enter] to edit /etc/elasticsearch/elasticsearch.yml"
